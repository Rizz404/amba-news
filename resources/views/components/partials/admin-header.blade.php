<header class="bg-gradient-to-r from-teto-dark to-teto-light text-white shadow-md">
    <div class="flex items-center justify-between px-4 md:px-8 py-5 mx-auto">
        <div class="flex">
            <button @click="sidebarOpen = !sidebarOpen" type="button"
                class="text-slate-200 hover:text-white focus:outline-none" aria-label="Toggle sidebar">
        ...
        <div class="flex-1 flex justify-center md:justify-start ml-4">
            ...
            <a href="{{ route('admin.dashboard.index') }}" class="bold text-2xl flex items-center text-teto-cream">

        ...
        <div class="mx-4 flex justify-between space-y-2">
          <div class="flex space-x-4">
            ...
            <div class="flex items-center space-x-2">
              <input type="text" placeholder="Search news..." class="rounded-full border border-gray-300 w-68 px-4 py-1.5 text-sm focus:outline-orange-300"/>
              <button class="cursor-pointer rounded-full bg-orange-500 px-4 py-1.5 text-sm font-semibold text-white transition">Search</button>
            </div>
          </div>
